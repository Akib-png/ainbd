...
import NavigationM from './Components/Navigation/NavigationM' 
...
<h1>  </h1>
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center custom-container">
    ...
    <img class ="img-jpg" src={jjImage} alt="Saul" />
    ...
    <div className="frontpp">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 custom-heading">
        ...
        <br className="hidden lg:inline-block" /> Call Syed Sayedul Haque Suman
      </h1>
...
<h1>  </h1>
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center custom-container">
    ...
    <img class ="img-jpg" src={saulImage} alt="Saul" />
    ...
    <div className="frontpp">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 custom-heading">
        ...
        Before you go to jail
        <br className="hidden lg:inline-block" /> call Saul goodman
      </h1>
      <p className="mb-8 leading-relaxed custom-paragraph">
        Copper mug try-hard pitchfork pour-over freegan heirloom neutra air plant cold-pressed tacos poke beard tote bag. Heirloom echo park mlkshk tote bag selvage hot chicken authentic turmeric truffaut hexagon try-hard chambray.
      </p>
...
<h1>  </h1>
    ...
    <div className="o-wrapper-l">
        <div className="hero flex flex-column">
            ...
            <div className="callBox flex">
                <input type="text" placeholder="Client ID" value={receiverID} onChange={e => setReceiverID(e.target.value)} className="form-input"/>
  ...
  function callPeer(id) {
    if(id!=='' && users[id] && id!==yourID){
      ...
      .catch(()=>{
        setModalMessage('You cannot place/ receive a call without granting video and audio permissions! Please change your settings to use ainbd.')
